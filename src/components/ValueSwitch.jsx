...
function ValueSwitch() {
  ...
  return (
    <div className="flex flex-col items-center gap-5 px-4 sm:px-6 lg:px-10 mb-10">
      {/* Switch Button */}
      <div className="flex flex-wrap gap-3 justify-center items-center">
        ...
        <button
          ...
          className={`
            w-28 sm:w-32 lg:w-36 h-10 text-sm sm:text-base font-semibold flex items-center justify-center
            transition-all duration-300 border rounded cursor-pointer
            ${selected === "value1" ? "bg-[#fafafb] text-[#2b323a] border-[#f2f2f2]" : "bg-transparent text-[#777] border-[#f2f2f2]"}
        ...
        <button
          ...
          className={`
            w-28 sm:w-32 lg:w-36 h-10 text-sm sm:text-base font-semibold flex items-center justify-center
            transition-all duration-300 border rounded cursor-pointer
            ${selected === "value2" ? "bg-[#fafafb] text-[#2b323a] border-[#f2f2f2]" : "bg-transparent text-[#777] border-[#f2f2f2]"}
            hover:bg-[#f5f5f5] hover:text-[#2b323a] hover:-translate-y-0.5 hover:shadow-sm
          `}
        >
          RESPONSIF
        ...
        <button
          ...
          className={`
            w-28 sm:w-32 lg:w-36 h-10 text-sm sm:text-base font-semibold flex items-center justify-center
            transition-all duration-300 border rounded cursor-pointer
            ${selected === "value3" ? "bg-[#fafafb] text-[#2b323a] border-[#f2f2f2]" : "bg-transparent text-[#777] border-[#f2f2f2]"}
            hover:bg-[#f5f5f5] hover:text-[#2b323a] hover:-translate-y-0.5 hover:shadow-sm
          `}
        >
          KOMITMEN
